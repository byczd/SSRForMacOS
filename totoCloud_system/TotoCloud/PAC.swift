...
//MARK: 生成PAC代理规则文件
//融合所选规则过滤内容，及js函数，生成内容并写到gfwlist.js,而后赋值给http://www.127.0.0.1:8090/proxy.pac
func GeneratePACFile() -> Bool {
    ...
    do {
        ...
        if let data = Data(base64Encoded: gfwlist, options: .ignoreUnknownCharacters) {
            ...
            var lines = str!.components(separatedBy: CharacterSet.newlines) //换行符分隔
            ...
            do {
                ...
                let jsPath = Bundle.main.url(forResource: (mode == "global") ? "bbp" : "abp", withExtension: "js")
