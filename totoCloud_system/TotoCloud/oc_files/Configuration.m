...
- (instancetype) initWithJSONDictionary:(NSDictionary *)dictionary {
    ...
    if (self) {
        ...
        self.profiles = [[NSMutableArray alloc] initWithCapacity:0];
        for (NSDictionary *iter in dictionary[@"profiles"]) {
            [self.profiles addObject:[[SSRProfile alloc] initWithJSONDictionary:iter]];
        }
    }
    return self;
}
...
- (NSDictionary *)JSONDictionary {
  ...
  
    {
        ...
        for (SSRProfile *iter in self.profiles) {
